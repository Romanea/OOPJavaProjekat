...
public class DodajKvadrat extends JDialog {
	...
	public static List<Kvadrat> kvadrati = new ArrayList<Kvadrat>();
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					if(Integer.parseInt(txtUnosStranice.getText())>0)
					{
					 ...
					 kvadrati.add(new Kvadrat(new Tacka(Integer.parseInt(txtUnosX.getText()),
					 ...
					 GlavniProzorSortiranje.prikaziListu();
					 dispose();
					}
					else
